...
Startifyはウェブサイトを作成するために必要なリソースがひととおり揃った静的コーディングの開発環境です。デザインから静的コーディングまでシンプルなウェブページから、jQueryやVue.jsなどのJavaScriptのフレームワークやライブラリを使ったウェブアプリケーションもワンストップで、タスクランナーのGlupを使って効率よく作成できます。
